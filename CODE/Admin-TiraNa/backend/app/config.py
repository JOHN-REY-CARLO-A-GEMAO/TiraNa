...
class Settings(BaseSettings):
    ...
    HOST_API_BASE_URL: str = "http://tirana-backend:5000"  # Host-TiraNa backend URL (Docker service name)
    CLIENT_API_BASE_URL: str = "http://host.docker.internal:5000"  # Client-TiraNa backend URL (via host.docker.internal)
