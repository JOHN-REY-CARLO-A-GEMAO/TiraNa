...
const navSections = [
  ...
  },
  {
    label: 'System',
    items: [
      { to: '/admin/admins', label: 'Admins', icon: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z' },
        ...
        <nav className="p-4">
          {navSections.map((section) => (
            <div key={section.label} className="mb-4">
              <p className="text-[10px] font-bold text-gray-500 uppercase tracking-[0.2em] px-4 mb-2">{section.label}</p>
